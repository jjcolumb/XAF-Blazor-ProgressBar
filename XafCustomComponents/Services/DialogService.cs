...
namespace XafCustomComponents
{
    public class DialogService : IDialogService
    {
        ...
        public async Task<bool?> ShowMessageBox(MessageBoxOptions messageBoxOptions, DialogOptions options = null)
        {
            var parameters = new DialogParameters()
            {
                ...
                [nameof(MessageBoxOptions.TitleColor)] = messageBoxOptions.TitleColor,
                [nameof(MessageBoxOptions.TitleType)] = messageBoxOptions.TitleType,
    ...
    public class MessageBoxOptions
    {
        ...
        public TextColor TitleColor { get; set; } = TextColor.Dark;
        public TextType TitleType { get; set; } = TextType.h6;
